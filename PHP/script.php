<?php
    ...
    // si le bouton "Soumettre" est cliqué
    if(isset($_POST['valider'])) {
        ...
        if(empty($_POST['user_email'])) {
            ...
            if(!preg_match("#^[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?@[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?\.[a-z]{2,}$#i",$_POST['user_email'])){
                    ...
                    if(empty($_POST['message'])) {
                        ...
                        if(empty($_POST['prenom'])) {
                            ...
                            if(empty($_POST['sujet'])) {
                                ...
                                $Entetes .= "From: Formulaire <".$_POST['user_email'].">\r\n";//de préférence une adresse avec le même domaine de là où, vous utilisez ce code, cela permet un envoie quasi certain jusqu'au destinataire
                                $Entetes .= "Reply-To: Formulaire <".$_POST['user_email'].">\r\n";
                                ...
                                //en fin, on envoi le mail
                                    if(mail($VotreAdresseMail,nl2br($Sujet),nl2br($Message),$Entetes)){//la fonction nl2br permet de conserver les sauts de ligne et la fonction base64_encode de conserver les accents dans le titre
